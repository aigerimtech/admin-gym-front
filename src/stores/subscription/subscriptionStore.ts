      ...
      (set) => ({
        ...
        fetchSubscriptions: async () => {
          try {
            ...
            const { currentAdmin } = useAdminStore.getState(); // Get admin info
            ...
            const endpoint = currentAdmin?.role === "admin" ? "/subscription/all" : "/subscription";
            ...
            if (currentAdmin?.role === "admin") {
              set({ subscriptions: response.data, subscription: null }); 
            } else {
              set({ subscription: response.data, subscriptions: [] }); 
            }
          } catch (error) {
